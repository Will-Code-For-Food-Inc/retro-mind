...
- Follow the spec in `SPEC.md` for protocol and data model changes.
- Keep `SPEC.md` as a contract document — no usage guidance, no implementation
  narrative.
- `README.md` is the human-facing entry point. Keep it accurate and concise.
